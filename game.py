...
sulivan_b1 = PhotoImage(file="textures/personnage/sulivan/sulivan_b1.gif")
sulivan_b2 = PhotoImage(file="textures/personnage/sulivan/sulivan_b2.gif")
sulivan_d1 = PhotoImage(file="textures/personnage/sulivan/sulivan_d1.gif")
sulivan_d2 = PhotoImage(file="textures/personnage/sulivan/sulivan_d2.gif")
sulivan_d3 = PhotoImage(file="textures/personnage/sulivan/sulivan_d3.gif")
sulivan_g1 = PhotoImage(file="textures/personnage/sulivan/sulivan_g1.gif")
sulivan_g2 = PhotoImage(file="textures/personnage/sulivan/sulivan_g2.gif")
sulivan_g3 = PhotoImage(file="textures/personnage/sulivan/sulivan_g3.gif")
sulivan_h1 = PhotoImage(file="textures/personnage/sulivan/sulivan_h1.gif")
sulivan_h2 = PhotoImage(file="textures/personnage/sulivan/sulivan_h2.gif")
sulivan_immobile1 = PhotoImage(file="textures/personnage/sulivan/sulivan_immobile1.gif")
sulivan_immobile2 = PhotoImage(file="textures/personnage/sulivan/sulivan_immobile2.gif")
sulivan_immobile3 = PhotoImage(file="textures/personnage/sulivan/sulivan_immobile3.gif")
sulivan_immobile4 = PhotoImage(file="textures/personnage/sulivan/sulivan_immobile4.gif")
sulivan_dort = PhotoImage(file="textures/personnage/sulivan/sulivan_dort.gif")

dave_b1 = PhotoImage(file="textures/personnage/dave/dave_b1.gif")
dave_b2 = PhotoImage(file="textures/personnage/dave/dave_b2.gif")
dave_d1 = PhotoImage(file="textures/personnage/dave/dave_d1.gif")
dave_d2 = PhotoImage(file="textures/personnage/dave/dave_d2.gif")
dave_d3 = PhotoImage(file="textures/personnage/dave/dave_d3.gif")
dave_g1 = PhotoImage(file="textures/personnage/dave/dave_g1.gif")
dave_g2 = PhotoImage(file="textures/personnage/dave/dave_g2.gif")
dave_g3 = PhotoImage(file="textures/personnage/dave/dave_g3.gif")
dave_h1 = PhotoImage(file="textures/personnage/dave/dave_h1.gif")
dave_h2 = PhotoImage(file="textures/personnage/dave/dave_h2.gif")
dave_immobile1 = PhotoImage(file="textures/personnage/dave/dave_immobile1.gif")
dave_immobile2 = PhotoImage(file="textures/personnage/dave/dave_immobile2.gif")
dave_immobile3 = PhotoImage(file="textures/personnage/dave/dave_immobile3.gif")
dave_immobile4 = PhotoImage(file="textures/personnage/dave/dave_immobile4.gif")
...
#CASES ACTIONS
interactionDave = PhotoImage(file="textures/cellules/sol.png")
...
with open("saves.txt", "r") as f:
    ...
    data["missionDave"] = int(data["missionDave"])
...
interdites = ["MCI1__","MCI2__","MCI3__","MCI4__","MI1___","MI2___","ME1A__","ME1B__","I_DAVE","I_FRAN",
...
def createMatrice(name):
    global ma_matrice, can1, canArgent, canMission, canTouche,affichageArgent, affichageMission, affichageTouche, bot_dave, bot_sulivan, bot_francois, bot_policier
    ...
    if name=="spawn":
        bot_dave = can1.create_image(posXdave, posYdave, image=dave_immobile1, anchor="nw")
        bot_sulivan = can1.create_image(640, 256, image=sulivan_dort, anchor="nw")
...
def touche_action(touche):
    ...
    elif ma_matrice[ligne-1][colonne] == "I_DAVE" or ma_matrice[ligne][colonne+1] == "I_DAVE" or \
...
def cases_argent():
    ...
    if ma_matrice[ligne][colonne] == "SACB__":
        data['money'] += 50
        data['mission'] = "Récolter 120$ puis retourner voir Dave."
        canMission.delete(affichageMission)
...
def Clavier(event):
    ...
    global lastMouv, isCinematic, bot_dave, ma_matrice, perso, posX, posY, can1x, can1y, vitesseAnimation, bot_francois, bot_policier, affichageMission
    touche = event.keysym
    ligne = posY // 64
    colonne = posX // 64
    ...
    if isCinematic == False:
        ...
        if touche == toucheDico['interaction'] and ma_matrice[ligne-1][colonne] == "I_DAVE":
            isCinematic = True
            ma_matrice[512 // 64][576 // 64] = "IPORTE"
            lastMouv = "up"
            lastMouvFonction()
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_immobile1, anchor="nw")

            if data['money'] < 120 and data['missionDave'] == 0:
                cinematicDave()
            elif data['money'] >= 120 and data['missionDave'] == 0:
                data['missionDave'] = 1
                cinematicDave2()
            elif data['missionDave'] == 1:
                cinematicDave3()

        #Le perso à gauche
        if touche == toucheDico['interaction'] and ma_matrice[ligne][colonne+1] == "I_DAVE":
            isCinematic = True
            ma_matrice[512 // 64][576 // 64] = "IPORTE"
            lastMouv = "right"
            lastMouvFonction()
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_immobile4, anchor="nw")
            if data['money'] < 120 and data['missionDave']==0:
                cinematicDave()
            elif data['money'] >= 120 and data['missionDave']==0:
                data['missionDave'] = 1
        ...
        if touche == "Return" and data['ecranNum'] == 10:
            if ma_matrice[ligne][colonne] == "LUMPO1":
                ...
                can1.create_image(128, 512, image=sulivan_d2, anchor="nw")
                ...
                data['mission'] = "Récupérer l'argent de Dave."
                canMission.delete(affichageMission)
                affichageMission = canMission.create_text(10, 27, font=("Times", "14", "bold italic"), anchor="w",text=f"{data['mission']}")
...
def upDave():
    global posXdave, posYdave, bot_dave, animationY1dave, animationY2dave, can1x, can1y, fpsUp

    if posYdave % 64 == 0:
        animationY1dave = posYdave
        animationY2dave = posYdave-16
    ...
    if posYdave%64 != 0:
        ...
        if animationY2dave <= posYdave <= animationY1dave:  # -16 < x < 0
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_h1, anchor="nw")
            can1.after(10, upDave)

        elif animationY1dave - 32 <= posYdave <= animationY2dave:  # -32 < x < -16
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_h2, anchor="nw")
            can1.after(10, upDave)

        elif animationY2dave - 32 <= posYdave <= animationY1dave - 32:  # -48 < x < -32
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_h1, anchor="nw")
            can1.after(10, upDave)

        elif animationY2dave - 48 <= posYdave <= animationY1dave - 48:  # -64 < x < -48
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_h2, anchor="nw")
            can1.after(10, upDave)
        ...
        can1.delete(bot_dave)
        bot_dave = can1.create_image(posXdave, posYdave, image=dave_immobile3, anchor="nw")




def downDave():
    global posXdave, posYdave, bot_dave, animationY1dave, animationY2dave, can1x, can1y, fpsDown
    if posYdave % 64 == 0:
        animationY1dave = posYdave
        animationY2dave = posYdave+16
    ...
    if posYdave%64 != 0:
        ...
        if animationY1dave <= posYdave <= animationY2dave:  # 0 < x < 16
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_b1, anchor="nw")
            can1.after(10, downDave)

        elif animationY2dave <= posYdave <= animationY1dave+32:  # 16 < x < 32
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_b2, anchor="nw")
            can1.after(10, downDave)

        elif animationY1dave <= posYdave <= animationY2dave + 32:  # 32 < x < 48
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_b1, anchor="nw")
            can1.after(10, downDave)

        elif animationY2dave + 32 <= posYdave <= animationY1dave + 64:  # 48 < x < 64
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_b2, anchor="nw")
            can1.after(10, downDave)
...
def leftDave():
    global posXdave, posYdave, bot_dave, animationX1dave, animationX2dave, can1x, can1y, fpsLeft

    if posXdave % 64 == 0:
        animationX1dave = posXdave
        animationX2dave = posXdave-22

    posXdave -= 8

    if posXdave%64 != 0:

        if animationX2dave <= posXdave <= animationX1dave: #-22 < x < 0
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_g1, anchor="nw")
            can1.after(10, leftDave)

        elif animationX1dave - 44 <= posXdave <= animationX2dave:  #-44 < x < -22
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_g2, anchor="nw")
            can1.after(10, leftDave)

        elif animationX2dave - 42 <= posXdave <= animationX1dave - 44:  #-64 < x < -44
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_g3, anchor="nw")
            can1.after(10, leftDave)
...
def rightDave():
    global posXdave, posYdave, bot_dave, animationX1dave, animationX2dave, can1x, can1y, fpsRight
    ...
    if posXdave%64 != 0:
        ...
        if animationX1dave <= posXdave <= animationX2dave:  # 0 < x < 22
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_d1, anchor="nw")
            can1.after(10, rightDave)

        elif animationX2dave <= posXdave <= animationX1dave + 44:  # 22 < x < 44
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_d2, anchor="nw")
            can1.after(10, rightDave)

        elif animationX1dave + 44 <= posXdave <= animationX2dave + 42:  # 44 < x < 64
            can1.delete(bot_dave)
            bot_dave = can1.create_image(posXdave, posYdave, image=dave_d3, anchor="nw")
            can1.after(10, rightDave)


    else:
        can1.delete(bot_dave)
        bot_dave = can1.create_image(posXdave, posYdave, image=dave_immobile2, anchor="nw")
...
dialogueNum = 0
dialogueCercleDave = 0
dialogueTextDave = 0
dialogueCercleMain = 0
dialogueTextMain = 0
def cinematicDave():
    global dialogueNum, dialogueTextMain, dialogueTextDave, dialogueCercleDave, dialogueCercleMain, variableCinematic
    canTouche.delete(affichageTouche)
    canMission.delete(affichageMission)
...
########################################################################################################################DAVE
    if dialogueNum == 0:
        ...
        dialogueCercleDave = can1.create_oval(posXdave+50, posYdave-64, posXdave+256, posYdave+32, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave+150,posYdave-16, justify="center",font=('Times', '12', 'italic') ,text="Yo, tu cherches un \nbon plan pour t'échapper ?")

        dialogueNum+=1
        can1.after(2500, cinematicDave)
########################################################################################################################MAIN
    elif dialogueNum == 1:
        can1.delete(dialogueTextDave)
        can1.delete(dialogueCercleDave)
...
########################################################################################################################DAVE
        ...
        dialogueCercleDave = can1.create_oval(posXdave + 20, posYdave - 64, posXdave + 256, posYdave + 32, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave + 138, posYdave - 16, justify="center",font=('Times', '12', 'italic'), text="Si tu me ramènes 120$,\nje te dis où comment\n tu peux sortir d'ici.")

        dialogueNum += 1
        can1.after(3500, cinematicDave)
########################################################################################################################MAIN
    elif dialogueNum == 3:
        can1.delete(dialogueTextDave)
        can1.delete(dialogueCercleDave)
...
########################################################################################################################DAVE
        ...
        dialogueCercleDave = can1.create_oval(posXdave + 20, posYdave - 64, posXdave + 256, posYdave + 32, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave + 138, posYdave - 16, justify="center",font=('Times', '12', 'italic'), text="C'est simple, y'a un prisonnier \nqui s'appelle Sulivan\n qui me dois des sous.")
...
########################################################################################################################DAVE
        ...
        dialogueCercleDave = can1.create_oval(posXdave + 20, posYdave - 64, posXdave + 256, posYdave + 32, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave + 138, posYdave - 16, justify="center",font=('Times', '12', 'italic'), text="Et j'ai l'impression qui veut\n pas me les rendre donc on va\n aller les récupérer.")
...
########################################################################################################################DAVE
        ...
        dialogueCercleDave = can1.create_oval(posXdave + 20, posYdave - 64, posXdave + 256, posYdave + 32, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave + 138, posYdave - 16, justify="center",font=('Times', '12', 'italic'), text="Je crois qu'il est \ndans sa cellule entrain de dormir.\n Suis-moi on y va.")

        dialogueNum += 1
        can1.after(3000, cinematicDave)
...
########################################################################################################################DAVE
        ...
        dialogueCercleDave = can1.create_oval(posXdave - 20, posYdave + 64, posXdave - 256, posYdave - 32, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave - 138, posYdave + 16, justify="center",font=('Times', '12', 'italic'),text="C'est ici. Essaye de détruire la\nporte et vole le sac de billet à\nson chevet.")
        ...
        dialogueCercleDave = can1.create_oval(posXdave - 10, posYdave + 64, posXdave - 300, posYdave - 64, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave - 155, posYdave, justify="center",font=('Times', '13', 'italic'),text="Je vais retourner à mon emplacement\nessaye de trouver des moyens de te faire\nde l'argent et reviens me voir.")

        dialogueNum += 1
        can1.after(4000, cinematicDave)
...
def mouvementCinematic():
    global variableCinematic, bot_dave, lastMouv, dialogueNum, isCinematic, can1, affichageTouche, affichageMission
    if lastMouv == "up":
        if variableCinematic == 1:
            can1.after(400, leftDave)
            can1.after(400, up)

        elif 2 <= variableCinematic <= 5:
            if variableCinematic == 2:
                can1.after(400, left)
                can1.after(400, downDave)
            ...
            can1.after(200, orienterDave)
            dialogueNum += 1
            can1.after(200, cinematicDave)
    ...
    if variableCinematic < 19:
        ...
        canTouche.delete(affichageTouche)
        affichageTouche = canTouche.create_text(6, 28, font=("Times", "10", "bold italic"), fill="white", anchor="w",text="ENTER")
        data['mission'] = "Entrer dans la cellule de Sulivan."
        canMission.delete(affichageMission)
        affichageMission = canMission.create_text(10, 27, font=("Times", "14", "bold italic"), anchor="w",text=f"{data['mission']}")
        isCinematic = False
...
def cinematicDave2():
    global dialogueNum, dialogueTextMain, dialogueTextDave, dialogueCercleDave, dialogueCercleMain, variableCinematic, affichageArgent, isCinematic, affichageMission
    canTouche.delete(affichageTouche)
    canMission.delete(affichageMission)
...
########################################################################################################################DAVE
    if dialogueNum == 0:
        ...
        dialogueCercleDave = can1.create_oval(posXdave+50, posYdave-64, posXdave+256, posYdave+32, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave+150,posYdave-16, justify="center",font=('Times', '16', 'italic') ,text="Alors t'as l'argent ?")

        dialogueNum+=1
        can1.after(2000, cinematicDave2)
########################################################################################################################MAIN
    elif dialogueNum == 1:
        can1.delete(dialogueTextDave)
        can1.delete(dialogueCercleDave)
...
########################################################################################################################DAVE
        ...
        dialogueCercleDave = can1.create_oval(posXdave + 20, posYdave - 64, posXdave + 256, posYdave + 32, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave + 138, posYdave - 16, justify="center",font=('Times', '16', 'italic'), text="Ok donne-moi 120$.")
...
########################################################################################################################DAVE
        ...
        dialogueCercleDave = can1.create_oval(posXdave+50, posYdave-64, posXdave+256, posYdave+32, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave+150,posYdave-16, justify="center",font=('Times', '11', 'italic') ,text="Prends cette clé.\nAvec, va dans le bureau de\npolice à coté de la cantine.")
        ma_matrice[960 // 64][896 // 64] = "LUMPO2"
        can1.create_image(896, 960, image=lumiereUnlock, anchor="nw")

        dialogueNum+=1
        can1.after(4000, cinematicDave2)
########################################################################################################################MAIN
    elif dialogueNum == 6:
        can1.delete(dialogueTextDave)
        can1.delete(dialogueCercleDave)

        dialogueCercleDave = can1.create_oval(posXdave + 50, posYdave - 64, posXdave + 256,posYdave + 64, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave + 150, posYdave, justify="center",font=('Times', '11', 'italic'),text="Une fois dedans,\nmet un uniforme, va à la sortie\n de la prison et demande de sortir.")
...
########################################################################################################################MAIN
        ...
        dialogueNum += 1
        can1.after(2500, cinematicDave2)
...
########################################################################################################################DAVE
        ...
        dialogueCercleDave = can1.create_oval(posXdave + 20, posYdave - 64, posXdave + 256, posYdave + 32, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave + 138, posYdave - 16, justify="center",font=('Times', '14', 'italic'), text="T'inquiète mon reuf.\nBonne chance !")
...
########################################################################################################################DAVE
    if dialogueNum == 0:
        ...
        dialogueCercleDave = can1.create_oval(posXdave+50, posYdave-64, posXdave+256, posYdave+32, fill="#FFE6C3")
        dialogueTextDave = can1.create_text(posXdave+150,posYdave-16, justify="center",font=('Times', '12', 'italic') ,text="T'as juste à aller dans\nle bureau,voler un uniforme et\ndemander de sortir.")

        dialogueNum+=1
        can1.after(5000, cinematicDave3)
########################################################################################################################MAIN
    elif dialogueNum == 1:
        can1.delete(dialogueTextDave)
        can1.delete(dialogueCercleDave)
